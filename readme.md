...
# To Run This , import the folder into your local workspace and navigate to the project directory and run "python app.py" command in terminal. Go to the server port to experience my creation. Make sure you had installed all dependencies mentioned in this file.
